...
class Detector:
    """Class Detector to choose the detector type."""
    ...
    def detect_object_in_images(self, image_path: str) -> None:
        ...
        if self.model_type != 4:
            ...
            output: VisImage = image_visualizer.draw_instance_predictions(
    ...
    def detect_object_in_video(self, video_path: str) -> None:
        ...
        while video_is_on:
            if self.model_type != "4":
                ...
                output: VisImage = visualizer.draw_instance_predictions(
                    predictions["instances"].to(device="cpu")
                )
